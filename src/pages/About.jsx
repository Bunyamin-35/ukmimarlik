...
import foto from "../assets/WhatsApp Image 2023-08-26 at 14.18.34.jpeg"

const About = () => {
    return (
        <>
            <section class="pt-10 overflow-hidden bg-gradient-to-b from-gray-400 md:pt-0 sm:pt-16 2xl:pt-16">
                <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                    <div class="grid items-center grid-cols-1 md:grid-cols-2">
                        ...
                        <div class="relative">
                            ...
                            <img class="mt-20 relative w-full xl:max-w-lg xl:mx-auto 2xl:origin-bottom 2xl:scale-110" src={foto} alt="" />
                        </div>
